...
my $file8 = "get_disease_dur_preg/out/liver_test.csv";
my $file10 = "get_disease_dur_preg/out/眼華閃発.csv";
my $file12 = "get_disease_dur_preg/out/視野.csv";
my $file13 = "get_disease_dur_preg/out/視野狭窄.csv";
my $file14 = "get_disease_dur_preg/out/高血圧後の頭痛.csv";

my $file16 = "get_disease_dur_preg/out/肺水腫.csv";
my $file17 = "get_disease_dur_preg/out/lowPLT.csv";


my @fileset1 = ($file8);
my @fileset2 = ($file10, $file12, $file13, $file14);
my @fileset3 = ($file16, $file17);


my $file = "RSL_transcribed.id_merged.conv.csv";
